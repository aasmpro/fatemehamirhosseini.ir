    ...
    <a href={window.location.origin} className="cursor-pointer select-none">
      <div
        ...
        <div className="relative">
          <div
            className={`absolute font-extrabold text-3xl left-[3px] text-white transition duration-300 group-hover:text-${stg.theme_color}-900`}>
            F
          </div>
          <div
            className={`absolute font-extrabold text-3xl left-[11px] text-${stg.theme_color}-900 transition duration-300 group-hover:text-${stg.theme_color}-300`}>
            A
          </div>
        </div>
      </div>
