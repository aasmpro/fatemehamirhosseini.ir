    ...
    <div
      ...
      <div className="font-extrabold mx-5 mb-10">
        ...
        <div className="font-bold flex flex-row flex-wrap">
          <div className="mt-2 bg-green-300 cursor-pointer px-3 pt-0.5 rounded-full transition duration-300 hover:ring-2 hover:ring-green-300 hover:bg-white text-green-900 mr-1.5 whitespace-nowrap select-none">
          ...
          <div className="mt-2 bg-green-300 cursor-pointer px-3 pt-0.5 rounded-full transition duration-300 hover:ring-2 hover:ring-green-300 hover:bg-white text-green-900 whitespace-nowrap select-none">
