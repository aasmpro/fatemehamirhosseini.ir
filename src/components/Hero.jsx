  ...
  return (
    <div
      ...
      <div className="relative group">
        <div
          class={`w-[280px] h-[280px] min-w-[280px] min-h-[280px] max-w-[280px] max-h-[280px] absolute -inset-0.5 bg-gradient-to-r from-${stg.theme_color}-800 to-${stg.theme_color}-300 rounded-full overflow-hidden mt-12 sm:mt-0 mx-3 -top-2 blur-lg opacity-50 group-hover:opacity-75 transition duration-1000 group-hover:duration-200 animate-tilt`}></div>
        <div
